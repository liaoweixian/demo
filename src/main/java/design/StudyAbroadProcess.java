...
abstract class StudyAbroad { //出国留学
    ...
    public void eeadyGoAbroad() { //体检、订机票、准备行装
        System.out.println("五.体检、订机票、准备行装：");
        System.out.println("  1）进行身体检查、免疫检查和接种传染病疫苗；");
        System.out.println("  2）确定机票时间、航班和转机地点。");
    }
}
class StudyInAmerica  extends StudyAbroad {  //具体子类 美国留学
    @Override
    public void lookingForSchool() {  //索取学校资料
    ...
    @Override
    public void applyForEnrol() { //入学申请
